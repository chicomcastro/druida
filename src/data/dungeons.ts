...
export interface DungeonTheme {
  ...
  miniboss: { name: string; mesh: string; hpMul: number; boss?: string };
}
...
export const DUNGEON_THEMES: Record<string, DungeonTheme> = {
  ...
  pantano: {
    ...
    miniboss: { name: 'Senhor do Lodo', mesh: 'husk', hpMul: 1.0, boss: 'mirelord' },
  },
  bosque_cinza: {
    name: 'Forno Afundado',
  ...
  picos: {
    ...
    miniboss: { name: 'Ceifador Gélido', mesh: 'wolf', hpMul: 1.1, boss: 'frostreaver' },
  },
  coracao: {
    name: 'Víscera',
