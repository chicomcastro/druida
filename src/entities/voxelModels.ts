...
const wolf: VoxelModelSpec = {
  ...
  parts: [
    ...
    { name: 'head', joint: [0, 0.6, 0.55], boxes: [
      ...
      b([0.09, 0.11, 0.06], [-0.14, 0.12, 0.34], 0xffcf5a), // olhos âmbar (ADR 0163)
      b([0.09, 0.11, 0.06], [0.14, 0.12, 0.34], 0xffcf5a),
    ] },
...
const bear: VoxelModelSpec = {
  ...
  parts: [
    ...
    { name: 'head', joint: [0, 0.95, 0.7], boxes: [
      ...
      b([0.1, 0.11, 0.06], [-0.16, 0.16, 0.34], 0x1a1a1a), // olhos (ADR 0163)
      b([0.1, 0.11, 0.06], [0.16, 0.16, 0.34], 0x1a1a1a),
    ] },
...
const raven: VoxelModelSpec = {
  ...
  parts: [
    ...
    { name: 'head', joint: [0, 1.05, 0.2], boxes: [
      ...
      b([0.08, 0.09, 0.05], [-0.11, 0.14, 0.26], 0xffe08a), // olhos (ADR 0163)
      b([0.08, 0.09, 0.05], [0.11, 0.14, 0.26], 0xffe08a),
    ] },
