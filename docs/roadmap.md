...
| E17 Hotbar 1–9 + skills | 🚧 em andamento (E17.1 fundação: árvore de skills ativas — data model + desbloqueio — ADR 0124; E17.2 UI da árvore no painel de Talentos — ADR 0125; E17.3a modelo da hotbar 1–9 — ADR 0126; E17.3b input+HUD+atribuição: teclas 1–4 conjuram skills, 5–9 formas, botões de slot no painel — ADR 0129; E17.4 VFX de conjuração por ramo (assinatura visual por elemento) — ADR 0130; a seguir: migração das passivas/formas ao modelo, remap livre 1–9 (E17.5)) | — |
