...
| E17 Hotbar 1–9 + skills | 🚧 em andamento (E17.1 fundação: árvore de skills ativas — data model + desbloqueio — ADR 0124; E17.2 UI da árvore no painel de Talentos — ADR 0125; a seguir: hotbar 1–9, VFX por ramo, migração) | — |
