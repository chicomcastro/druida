...
| E18 Hotbar totalmente livre | 🚧 em andamento (E18.1 modelo de entradas tipadas — skill/forma/poção/equip em qualquer slot, migração de save, formas semeadas mas remapeáveis, HUD por tipo, atribuição de skill/forma no painel — ADR 0132; a seguir: E18.2 atribuir equipamento/poção pelo inventário + troca de equipamento por tecla com swap-back + prune; E18.3 opcional comida/buff) | 🚧 |
