...
| E20 Plantação | 🚧 E20.1 fundação: culturas plantáveis (erva/cenoura/cogumelo) + sementes na despensa + canteiros com plantar/crescer/colher (funções puras, salvas no progresso) — ADR 0141; E20.2 canteiros interativos na praça da Clareira + painel de plantio/colheita + crescimento visual (broto→fruto) — ADR 0142; a seguir: sementes no mercador + estágios visuais/dia (E20.3) | — |
