...
| E17 Hotbar 1–9 + skills | 🚧 em andamento (E17.1 fundação: árvore de skills ativas — data model + desbloqueio — ADR 0124; E17.2 UI da árvore no painel de Talentos — ADR 0125; E17.3a modelo da hotbar 1–9 — ADR 0126; a seguir: fiação input/HUD da hotbar, VFX por ramo, migração) | — |
