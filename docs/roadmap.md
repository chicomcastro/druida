...
| E19 Culinária & Craft | 🚧 em andamento (E19.1 fundação: despensa de ingredientes empilháveis + receitas + nível de Craft + buffs/despensa/craft salvos + ícones certos na hotbar + monstros dropam ingredientes no lugar de comida pronta — ADR 0135; E19.2 bancada de cozinha: caldeirão na praça + painel de craft (have/need, lock por nível, despensa) + cozinhar consome/dá XP/gera comida — ADR 0136; E19.3 forrageamento: nós de coleta por bioma espalhados no mapa (colher com E, respawn) — ADR 0137; a seguir: E19.4 mercador vende ingredientes/comida) | 🚧 |
