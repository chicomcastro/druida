...
| E17 Hotbar 1–9 + skills | 🚧 em andamento (E17.1 fundação: árvore de skills ativas — data model + desbloqueio — ADR 0124; a seguir: UI da árvore, hotbar 1–9, VFX por ramo, migração) | — |
