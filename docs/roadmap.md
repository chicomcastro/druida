...
| E22 Vila viva (moradia + rotina) | 🚧 E22.1 rotina de dia/noite por arquétipo (trabalho/passeio/casa) + almoço e reunião ao entardecer no salão comunal + variação diária (vila nunca igual) — ADR 0147; a seguir: casas residenciais + famílias/gênero com atribuição casa↔morador (E22.2), aldeões conversando entre si (E22.3) | — |
