...
| E20 Plantação | 🚧 E20.1 fundação: culturas plantáveis (erva/cenoura/cogumelo) + sementes na despensa + canteiros com plantar/crescer/colher (funções puras, salvas no progresso) — ADR 0141; a seguir: canteiros interativos + UI de plantio (E20.2), sementes no mercador + estágios visuais/dia (E20.3) | — |
