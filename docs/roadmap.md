...
| E21 Mercadores especializados + sementes no drop | 🚧 E21.1 sementes no forrageamento: chance de dropar a semente da cultura ao colher no mundo — ADR 0144; a seguir: estoques especializados por casa + cozinheiro na taverna (E21.2), jardineiro que vende sementes numa casa nova em cada vila (E21.3) | — |
