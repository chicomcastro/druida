...
- ~~**Famílias/rixa só na Clareira**~~ ✅ **Resolvido (ADR 0107)**: as 4 vilas
  têm par de famílias rivais + arco de reconciliação. Falta apenas **reputação
  por vila** (recompensa mecânica por resolver a rixa) — próximo passo.
